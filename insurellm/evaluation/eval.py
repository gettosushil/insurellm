...
# Load .env from project root regardless of cwd (fixes ModuleNotFoundError when cwd != insurellm/)
load_dotenv(dotenv_path=Path(__file__).parent.parent / ".env", override=True)
load_dotenv(override=True)

# Use OpenRouter via litellm - requires OPENROUTER_API_KEY. Validated: openai/gpt-4o-mini works, nvidia free tier times out.
